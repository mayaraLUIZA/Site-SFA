...
WebUI.click(findTestObject('Page_Dataplace - SFA/Page_Dataplace SFA/div_1589'))

WebUI.click(findTestObject('Page_Dataplace - SFA/Page_Dataplace SFA/i_Enviar por e-mail_fas text-danger fa-time_2845d7'))

WebUI.click(findTestObject('Page_Dataplace - SFA/Page_Dataplace SFA/button_Confirmar (4)'))
