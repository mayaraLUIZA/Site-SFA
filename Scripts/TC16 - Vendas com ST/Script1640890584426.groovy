...
WebUI.setText(findTestObject('Page_Dataplace - SFA/Page_Dataplace SFA/input_Cliente_clienteId'), 'Premium')

WebUI.click(findTestObject('Object Repository/Page_Dataplace SFA/span_Cliente'))

WebUI.setText(findTestObject('Page_Dataplace - SFA/Page_Dataplace SFA/input_Tipo de pedido_tipoPedido'), 'Vendas_ST')
...
WebUI.setText(findTestObject('Page_Dataplace - SFA/Page_Dataplace SFA/input_Produto_typeahead-produto'), '8029ST')
